...
#define H5 A6
#define H6 A7
extern int h1,h2,h3,h4,h5,h6,coderA,coderB,daocheflag,crossflag,time,daochejiesu,daochestar,yao,HONG;
#include "headfile.h"
#include "isr.h"
...
void TIM16_IRQHandler (void)
{
	...
	coderB=-tim_encoder_get_count (TIM_1 );
	coderA=tim_encoder_get_count (TIM_8 );
	if(daocheflag==1)
	{
		/*if(crossflag==1)
		{
